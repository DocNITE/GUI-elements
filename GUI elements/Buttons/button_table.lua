...
AddButton({
	...
	x = 2000,
	y = 47,
	max_x = 3440,  							  --// Размещение текстуры. X и Y - начальные точки, MAX_X и MAX_Y - конечные точки.
	max_y = 500,
	...
	text = "ADJASOIJDOA",    						  --// Отображаемый текст. Если не обязателен, то просто сделайте пустое поле " ".
	rgb = 
	{
